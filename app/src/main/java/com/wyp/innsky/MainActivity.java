...
public class MainActivity extends AppCompatActivity
    ...
    private void initCustomAnnimation(Activity target){
        CustomAnnotation customAnnotation = target.getClass().getAnnotation(CustomAnnotation.class);
